...
cp fcbenchtool fcplottool fccomparetool fcanalyzetool fcdebugtool fcasmtool fcexplorer.py fcexplore-bench.py fcbenchgraph.py fcanalyze.py fcoptimize.py "$INSTALL_DIR"
...
chmod 755 "$INSTALL_DIR/fcexplore-bench.py"
...
ln -sf "$INSTALL_DIR/fcexplore-bench.py" "$INSTALL_DIR/fcexplore-bench"
